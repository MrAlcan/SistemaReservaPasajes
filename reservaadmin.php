		...
		<div class="gtco-container">
			...
			<div class="row">
				<div class="col-sm-4 col-xs-12">
					<div id="gtco-logo"><a href="index.html">Sistema <em>Minasa</em></a></div>
				</div>
				<div class="col-xs-8 text-right menu-1">
					<ul>
						<li><a href="admin.php">Inicio</a></li>
						<li><a href="reservaadmin.php">Reserva</a></li>
						<li><a href="salidas.php">Destinos</a></li>
				...
				<div class="col-md-12 col-md-offset-0 text-left">
					...
					<div class="row row-mt-10em">
						<div class="col-md-12 mt-text animate-box" data-animate-effect="fadeInUp">
							<h1><center>BIENVENIDO A SISTEMA MINASA<BR> Plataforma Para Venta De Tus Viajes</BR></h1>	
						</div>
					</div>
<center>
...
<div class="row">
	...
	<div class="span12">
		...
		<?php
				...
				$sql=("SELECT * FROM reservaciones WHERE agencia='$us'");
	
				$query=mysqli_query($mysqli,$sql);

				echo "<table border='10'; class='btn btn-primary';>";
					echo "<tr class='warning'>";
						echo "<td><font color='6D6D71' size='5'>#N°<br></font></td>";
					    echo "<td><font color='000000' size='5'>Nombre<br></font></td>";
						echo "<td><font color='6D6D71' size='5'>Agencia<br></font></td>";
						echo "<td><font color='000000' size='5'>Destino<br></font></td>";
						echo "<td><font color='6D6D71' size='5'>Fecha<br></font></td>";
						echo "<td><font color='000000' size='5'>Hora<br></font></td>";
						echo "<td><font color='6D6D71' size='5'>Precio<br></font></td>";
						echo "<td><font color='000000' size='5'>Cantidad<br></font></td>";
			...
			<?php 
				...
				$num = 1;
				 while($arreglo=mysqli_fetch_array($query)){
					  ...
					  echo "<td><font color='6D6D71'>$num</font></td>";
						...
						echo "<td><font color='6D6D71'>$arreglo[5]</font></td>";
