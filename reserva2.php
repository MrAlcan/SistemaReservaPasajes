				...
				<div class="col-md-12 col-md-offset-0 text-left">
					...
					<div class="row row-mt-15em">
						<div class="col-md-7 mt-text animate-box" data-animate-effect="fadeInUp">
							<h1>Planeando viaje a cualquier parte de los Yungas?</h1>	
						</div>
								...
								<div class="tab">
									...
									<div class="tab-content">
										<div class="tab-content-inner active" data-content="signup">
											...
											<form action="datosReservas.php" method="POST" >
                                                ...
                                                <?php
                                                    ...
                                                    $sql=("SELECT * FROM destinos WHERE fecha='$fecha' and destino='$destino'");
												...
												<div class="row form-group">
													<div class="col-md-12">
														...
														<input type="date" name="fecha" id="date" class="form-control" value="<?php echo $fecha?>">
													</div>
												</div>
												
												<div class="row form-group">
													<div class="col-md-12">
														<label for="destination">Precios Disponibles Para El Destino Seleccionado</label>
														<select name="precio" id="destination" class="form-control" required="">

                                                            <?php
                                                                $query=mysqli_query($mysqli,$sql);
                                                                while($arreglo=mysqli_fetch_array($query)){
                                                                    echo "<option value=$arreglo[4]>$arreglo[4]</option>";
												...
												<div class="row form-group">
													<div class="col-md-12">
														<label for="activities">Cantidad de Pasajes</label>
														<select name="cantidad" id="activities" class="form-control" required="">
