				...
				<div class="col-md-12 col-md-offset-0 text-left">
					...
					<div class="row row-mt-10em">
						<div class="col-md-12 mt-text animate-box" data-animate-effect="fadeInUp">
							<h1><center>BIENVENIDO AL SISTEMA DE RESERVA DE PASAJES DE LA TERMINAL MINASA<BR> Plataforma Para Reservar Tus Viajes</BR></h1>	
						</div>
					</div>
<center>
	...
	<a href="salidas.php">				
					<button class="btn btn-info"><font size="4">DESTINOS</font><br><br><img src="images/precio.png" width="150"></button>
	</a>
