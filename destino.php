				...
				<div class="col-md-12 col-md-offset-0 text-left">
					...
					<div class="row row-mt-15em">
						<div class="col-md-7 mt-text animate-box" data-animate-effect="fadeInUp">
							<h1>Registro de destinos de Agencia</h1>	
						</div>
								...
								<div class="tab">
									...
									<div class="tab-content">
										<div class="tab-content-inner active" data-content="signup">
											<h3>Registra el destino</h3>

											<form action="datosDestino.php" method="POST" >
												...
												<div class="row form-group">
													<div class="col-md-12">
														...
														<?php
															...
															$ses = $_SESSION['id'];
															$us = $_SESSION['user'];
															$sql=("SELECT * FROM login WHERE id=$ses");
												...
												<div class="row form-group">
													<div class="col-md-12">
														...
														<select name="destino" id="destination" class="form-control" required="">
															...
															<option value="Sapecho">Sapecho</option>
															<option value="Chicaloma">Chicaloma</option>
												...
												<div class="row form-group">
													<div class="col-md-12">
														<label for="hora-start">Hora de viaje</label>
														<input type="time" name="hora" id="hora-start" class="form-control" ">
													</div>
												</div>
												...
												<div class="row form-group">
													<div class="col-md-12">
														...
														<input type="number" name="precio" id="precioViaje" class="form-control" required="">
													</div>
												</div>
