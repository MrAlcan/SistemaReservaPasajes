...
<html>
		...
		<div class="gtco-container">
			...
			<div class="row">
				<div class="col-sm-4 col-xs-12">
					<div id="gtco-logo"><a href="admin.php"><font color="black">SISTEMA <em>MINASA</em></font></a></div>
				</div>
				<div class="col-xs-8 text-right menu-1">
					<ul>
                        <li><a href="admin.php"><font color="black">Inicio</font></a></li>
						<li><a href="reservaadmin.php"><font color="black">Reserva</font></a></li>
						<li><a href="salidas.php"><font color="black">Destinos</font></a></li>
						<li><a href="contactoadmin.php"><font color="black">Contactos</font></a></li>
	...
	<div class="gtco-section border-bottom">
		<div class="gtco-container">
			...
			<center><p>SALIDAS DE LA TERMINAL</p></center>
				...
				<div class="table-responsive">          
					<table class="table">
                        ...
                        <?php
							...
							$sql=("SELECT * FROM destinos WHERE agencia='$us'");
        ...
        <center>
            <a href="destino.php">				
                <button class="btn btn-info"><font size="4">Agregar Destino</font></button>
            </a>
        </center>
